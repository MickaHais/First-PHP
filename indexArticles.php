    ...
    <body>
        <?php
            ...
            foreach ($articles as $article) {
                ...
                echo "<p>" . ($article['contenu'] ?? "Ce super article n'a pas de contenu.") . "</p>";
                echo "<img src='" . $article['image'] . "' alt='" . $article['image_alt'] . "'>";
                echo "<p>Image copyright: " . $article['image_copyright'] . "</p>";
                echo "<hr>";
            }
        ?>
    </body>
